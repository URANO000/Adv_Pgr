...
BEGIN
    ...
    BEGIN
        RAISERROR('La publicación no existe, no pertenece al usuario o está inactiva.', 16, 1);
        RETURN;
    END
...
BEGIN
    ...
    BEGIN
        RAISERROR('La publicación no existe, no pertenece al usuario o ya está inactiva.', 16, 1);
        RETURN;
    END
